 ...
 * Copyright (c) 2009-2011 by TheMatterofMemory_Version_20, Inc. All Rights Reserved.
...
//@interface TheMatterofMemory_Version_20Object : NSObject
//@end

@interface TheMatterofMemory_Version_20Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TheMatterofMemory_Version_20Object class]])
		{
			for (NSString *key in [[(TheMatterofMemory_Version_20Object*)o modules] allKeys])
			{
