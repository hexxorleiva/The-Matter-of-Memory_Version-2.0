...
static NSString * const kTheMatterofMemory_Version_20Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_thematterofmemory_version_20Injection
{
	...
	[html appendString:kTheMatterofMemory_Version_20Javascript];
...
{
	// attempt to make well-formed HTML and inject in our TheMatterofMemory_Version_20 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _thematterofmemory_version_20Injection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to TheMatterofMemory_Version_20 support.",url);
				}
			}
