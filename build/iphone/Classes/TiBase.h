...
// in simulator we redefine to format for TheMatterofMemory_Version_20 Developer console
...
{\
	NSString * exceptionName = [@"org.thematterofmemory_version_20." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.thematterofmemory_version_20";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITheMatterofMemory_Version_20NativeItemNone = -1, 
	UITheMatterofMemory_Version_20NativeItemSpinner = -2,
	UITheMatterofMemory_Version_20NativeItemProgressBar = -3,
	
	UITheMatterofMemory_Version_20NativeItemSlider = -4,
	UITheMatterofMemory_Version_20NativeItemSwitch = -5,
	UITheMatterofMemory_Version_20NativeItemMultiButton = -6,
	UITheMatterofMemory_Version_20NativeItemSegmented = -7,
	
	UITheMatterofMemory_Version_20NativeItemTextView = -8,
	UITheMatterofMemory_Version_20NativeItemTextField = -9,
	UITheMatterofMemory_Version_20NativeItemSearchBar = -10,
	
	UITheMatterofMemory_Version_20NativeItemPicker = -11,
	UITheMatterofMemory_Version_20NativeItemDatePicker = -12,
	
	UITheMatterofMemory_Version_20NativeItemInfoLight = -13,
	UITheMatterofMemory_Version_20NativeItemInfoDark = -14,
	
	UITheMatterofMemory_Version_20NativeItemDisclosure = -15,
	
	UITheMatterofMemory_Version_20NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TheMatterofMemory_Version_20 instances of
