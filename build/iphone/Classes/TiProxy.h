...
//Rare exceptions to indicate a bug in the _thematterofmemory_version_20 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TheMatterofMemory_Version_20 proxies.
 */
