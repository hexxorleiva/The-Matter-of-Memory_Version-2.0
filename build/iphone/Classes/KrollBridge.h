...
@interface TheMatterofMemory_Version_20Object : KrollCoverageObject {
#else
@interface TheMatterofMemory_Version_20Object : KrollObject {
#endif
@private
...
extern NSString * TheMatterofMemory_Version_20$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TheMatterofMemory_Version_20Object *_thematterofmemory_version_20;
	BOOL shutdown;
